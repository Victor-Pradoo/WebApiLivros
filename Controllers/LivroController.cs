...
namespace WebApi8_Livros.Controllers
{
    ...
    public class LivroController : ControllerBase
    {
        ...
        [HttpGet("BuscarLivrosPorIdAutor/{idLivro}")]
        public async Task<ActionResult<ResponseModel<List<LivroModel>>>> BuscarLivrosPorIdAutor(int idLivro)
        {
            var livros = await _livroInterface.BuscarLivrosPorIdAutor(idLivro);
            return Ok(livros);
        }
